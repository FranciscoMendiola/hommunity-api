...
public class UsuarioController {
    ...
    @PreAuthorize("hasAuthority('RESIDENTE') and @svcUsuario.isRegistrador(authentication.principal)")
    ...
    public ResponseEntity<ApiResponse> updateEstadoUsuario(
            @Valid @PathVariable("id") Long idUsuario, 
            @Valid @RequestBody DtoEstadoUsuariIn in, 
            BindingResult bindingResult,
        ...
        return svUsuario.updateEstadoUsuario(idUsuario, in, authentication);
    }
    ...
    public ResponseEntity<ApiResponse> updateContraseña(
            @Valid @PathVariable("id") Long idUsuario, 
            @Valid @RequestBody DtoUsuarioContraseñaIn in, 
            BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            FieldError fieldError = bindingResult.getFieldError();
            String errorMessage = fieldError != null ? fieldError.getDefaultMessage() : "Validation error";
